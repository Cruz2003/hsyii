...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>人大代表个人信息列表</h1></div><!--box-title end-->
...
?>
                    <tr>
                        ...
                        <td style='text-align: center;'>
                            <a class="btn" href="<?php echo $this->createUrl('read', array('id'=>$v->id));?>" title="查看"><i class="fa fa-edit"></i></a>
