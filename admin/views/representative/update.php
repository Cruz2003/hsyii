<div class="box">
    ...
    <?php  $form = $this->beginWidget('CActiveForm', get_form_list());?>
        ...
        <div class="box-detail-submit"><button onclick="submitType='baocun'" class="btn btn-blue" type="submit">保存</button><button type="button" class="btn btn-blue" onclick="we.back();">取消</button></div>
