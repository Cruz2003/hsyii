    ...
    <?php  $form = $this->beginWidget('CActiveForm', get_form_list());?>
        ...
        <div class="box-detail-bd">
            <div style="display:block;" class="box-detail-tab-item">
                <table>
                    <tr>
                        <td colspan="2"><?php echo $form->labelEx($model, 'num'); ?></td>
                        <td colspan="2">
                            <?php echo $model->num; ?>
                        </td>
                        <td colspan="2"><?php echo $form->labelEx($model, 'check'); ?></td>
                        <td colspan="2">
                                <select id="check">
        ...
        <div class="box-detail-submit"><button class="btn btn-blue" type="button" onclick="we.back();">取消</button></div>
