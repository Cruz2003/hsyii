...
<div class="box">
    ...
    <div class="box-content">
        <div class="box-header">
            ...
            <a class="btn" href="<?php echo $this->createUrl('create');?>"><i class="fa fa-plus"></i>添加机构信息</a>
        </div><!--box-header end-->
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('column');?></th>
...
?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo $v->column; ?></td>
