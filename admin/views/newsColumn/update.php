                ...
                <table>
                    ...
                    <tr>
                     ...
                     <tr>
                       ...
                       <tr>
                         <td><?php echo $form->labelEx($model, 'column_img'); ?></td>
                        <td>
                            <?php echo $form->hiddenField($model, 'column_img', array('class' => 'input-text fl')); ?>
                            <!-- face_game_bigpic -->
                         ...
                         <div class="upload_img fl" id="upload_pic_NewsColumn_pic"> 
                          <?php if(!empty($model->column_img)) {?>
                             <a href="<?php echo $basepath.$model->column_img;?>" target="_blank">
                             <img src="<?php echo $basepath.$model->column_img;?>" width="100">
                             </a>
                             <?php }?>
                             </div>
                            <script>we.uploadpic('<?php echo get_class($model);?>_column_img','<?php echo $picprefix;?>','','','',0);</script>
                            <?php echo $form->error($model, 'column_img', $htmlOptions = array()); ?>
                        </td>
                    </tr>
