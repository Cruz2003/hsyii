...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>阅读栏目列表</h1></div><!--box-title end-->
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('typename');?></th>
                        <th style='text-align: center;'><?php echo $model->getAttributeLabel('introduce');?></th>
                        <th style='text-align: center;'>关于栏目操作</th>
                        <th style='text-align: center;'>查看栏目文章</th>
                    </tr>
                </thead>
                <tbody>
<?php 
                    ...
                    <tr>
                        ...
                        <td style='text-align: center;'>
                            ...
                            <a class="btn" href="javascript:;" onclick="we.dele('<?php echo $v->id;?>', deleteUrl);" title="删除"><i class="fa fa-trash-o"></i></a>  
                             ...
                             <td style='text-align: center;'>
                             <a class="btn" href="<?php echo $this->createUrl('read/index', array('type_id'=>$v->id));?>" title="查看"><i class="fa fa-tasks"></i></a>
                        </td>
                    </tr>
<?php $index++; } ?>
                </tbody>
