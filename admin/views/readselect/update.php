<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>修改栏目信息</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
        ...
        <div class="box-detail-bd">
            <div style="display:block;" class="box-detail-tab-item">
                <table>
                	...
                	<tr>
                    	<td width="30%"><?php echo $form->labelEx($model, 'typename'); ?></td>
                       <td width="30%">
                            <?php echo $form->textField($model, 'typename', array('class' => 'input-text')); ?>
                    ...
                    <tr>
                       ...
                       <tr>
                        ...
                        <td>
                            ...
                            <!-- face_game_bigpic -->
                            <?php $basepath=BasePath::model()->getPath().'readselect/';
                            $picprefix='';
