...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i><?php echo $type_name;?>阅读栏目列表</h1>
        <span class="back" style="position: absolute;right:0px;"><a class="btn" href="<?php echo $this->createUrl('readselect/index')?>"><i class="fa fa-reply"></i>返回</a></span>
    </div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a>
            <a class="btn" href="<?php echo $this->createUrl('create');?>"><i class="fa fa-plus"></i>添加文章</a>
