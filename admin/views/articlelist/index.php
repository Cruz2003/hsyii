...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>稿件浏览</h1>   </div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a>
            <a class="btn" href="<?php echo $this->createUrl('create'); ?>"><i class="fa fa-plus"></i>添加稿件</a>
        ...
        <div class="box-table">
            <table class="list">
                ...
                <tbody>
                    ...
                    <?php 
                        $index = 1;
                        foreach(array_reverse($arclist) as $v){ 
                    ?>
                    <tr>  
                        ...
                        <td style='text-align: center;'>
                            ...
                            <a class="btn" href="<?php echo $this->createUrl('update0', array('id'=>$v->id));?>" title="审核"><i class="fa fa-edit"></i></a>
                        </td>
                    </tr>
<?php $index++; } ?>
                </tbody>
...
function preview(id){
 $.dialog.open('<?php echo $this->createUrl("Essay/preview");?>&id='+id,{
            id:'essay',
            lock:true,
            opacity:0.3,
            title:'文章预览',
...
//  $.dialog.open('<?php echo $this->createUrl("Essay/read");?>&wordname='+wordname,{
//             id:'essay',
//             lock:true,
//             opacity:0.3,
//             title:'文章预览',
